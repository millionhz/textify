...
# --image-size is used to force image size of the output image but its not unnecessary
# parser.add_argument("--image-size",
#                     action="store", nargs=2, type=int, metavar=("X", "Y"),
#                     help="size of produced image")
...
with Image.open(IMAGE_FILE).convert("L") as img:
    ...
    # as it is implimented in C which makes the program faster
